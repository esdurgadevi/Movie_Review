    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <span className="text-white text-xl font-bold">CineStream Admin</span>
            </motion.div>
          ...
          <div className="md:hidden py-4 border-t border-gray-700">
            <div className="flex flex-wrap gap-2">
              <button
                onClick={() => navigate('/create')}
                className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded-lg text-sm flex-1 min-w-[120px] justify-center"
              >
                <Plus size={16} />
                Create
              </button>
              <button
                onClick={() => navigate('/userlist')}
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg text-sm flex-1 min-w-[120px] justify-center"
              >
                <Users size={16} />
                Users
              </button>
              <button
                onClick={() => navigate('/dashboard')}
                className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-lg text-sm flex-1 min-w-[120px] justify-center"
              >
                <BarChart3 size={16} />
                Dashboard
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Manage all movies in your streaming platform</p>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <select
              ...
              className="bg-gray-800 border border-gray-700 rounded-lg px-4py-2 focus:outline-none focus:border-red-500"
            >
        ...
        >
          <h2 className="text-2xl font-bold mb-6">
            {searchTerm || Object.values(filters).some(f => f) ? 'Search Results' : 'All Movies'}
              ...
              <div className="relative h-80 lg:h-96">
                ...
                <div className="absolute top-4 right-4 flex gap-2">
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 rounded-full p-3 transition-all shadow-lg"
                  >
                    <Edit3 size={20} />
                  </button>
                  <button
                    ...
                    className="bg-red-600 hover:bg-red-700 rounded-full p-3 transition-all shadow-lg"
                  >
                    <Trash2 size={20} />
                  </button>
                  <button
                            ...
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center gap-3">
                                ...
                                <span className="font-semibold text-white text-lg">
                                  User {review.userId?.slice(-6) || 'Anonymous'}
                                </span>
                              </div>
                              <div className="flex items-center gap-2 bg-yellow-500/20 px-3 py-1 rounded-full">
      ...
      {/* Edit Movie Modal - Keep the existing edit modal code */}
      <AnimatePresence>
        {editingMovie && (
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            {/* ... (keep the existing edit modal code) ... */}
          </motion.div>
        )}
      </AnimatePresence>
    </div>
